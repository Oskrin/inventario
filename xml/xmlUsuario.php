...
if ($start < 0)
    $start = 0;
if ($search == 'false') {
    $SQL = "select U.id_usuario, U.nombre_usuario, U.apellido_usuario, U.ci_usuario, U.telefono_usuario, U.celular_usuario, U.clave, U.email_usuario, U.direccion_usuario, U.usuario, U.cargo_usuario from usuario U ORDER BY  $sidx $sord offset $start limit $limit";
} else {
